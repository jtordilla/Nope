//use when near crater with OpenCV
...
@Autonomous
public class CraterBestCV extends CVTemplate {
    ...
    public void rightGold(){
        ...
        leftDistance(normalSpeed, ticksPerInch(120));
        forwardDistance(normalSpeed, ticksPerInch(550));
    ...
    public void leftGold(){
        ...
        forwardDistance(slowSpeed, ticksPerInch(500));
        backDistance(normalSpeed, ticksPerInch(200));
        leftDistance(normalSpeed, ticksPerInch(83));
        forwardDistance(normalSpeed, ticksPerInch(500));
        leftDistance(normalSpeed, ticksPerInch(50));
        forwardDistance(fastSpeed, ticksPerInch(800));
        dropMarker();
        rightDistance(normalSpeed, ticksPerInch(240));
        forwardDistance(fastSpeed, ticksPerInch(1500));
    ...
    public void centerGold(){
        ...
        forwardDistance(slowSpeed, ticksPerInch(500));
        backDistance(normalSpeed, ticksPerInch(100));
        leftDistance(normalSpeed, ticksPerInch(130));
        forwardDistance(normalSpeed, ticksPerInch(650));
