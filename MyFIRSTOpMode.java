...
@TeleOp
public class MyFIRSTOpMode extends BasicOpMode_Linear{
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while(opModeIsActive()){
            ...
            else if(gamepad1.y == true && gamepad1.x == false){
                intake.setPower(intakePower);
            }
            else if(gamepad1.y == false && gamepad1.x == true){
                intake.setPower(-intakePower);
            }else{
                intakeStop();
            }
            ...
            if(gamepad1.dpad_left == true && gamepad1.dpad_right == false){
                pinion.setPower(Pin);
            }else if(gamepad1.dpad_right == true && gamepad1.dpad_left == false){
                pinion.setPower(-Pin);
            }else{
                pinionStop();
            }
